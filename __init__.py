...
def preload_users():
    ...
    c1 = Class(title='课程一 21天精通VUE', info='精通VUE, 愉快学习，轻松拿offer', learn_url='https://time.geekbang.org/')
    c2 = Class(title='课程二 21天精通FLASK', info='精通Flask, 愉快学习，轻松拿offer', learn_url='https://time.geekbang.org/')
    c3 = Class(title='课程三 21天精通Python', info='精通Python, 愉快学习，轻松拿offer', learn_url='https://time.geekbang.org/')
    c4 = Class(title='课程四 21天精通JAVA', info='精通JAVA, 愉快学习，轻松拿offer', learn_url='https://time.geekbang.org/')
    ...
    p1 = Problem(content='小学数学题：19 + 23等于多少？', classId=1)
    p2 = Problem(content='初中数学题：22的平方等于多少?', classId=1)
    i1 = Item(content='78', problemId=1, correct=0)
    i2 = Item(content='42', problemId=1, correct=1)
    i3 = Item(content='400', problemId=2, correct=0)
    i4 = Item(content='484', problemId=2, correct=1)
    i5 = Item(content='987', problemId=2, correct=0)
